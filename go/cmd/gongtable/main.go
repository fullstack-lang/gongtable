...
func main() {
	...
	stageForManualyEditedTable, backRepoForManualyEditedTable = gongtable_fullstack.NewStackInstance(r, "manualy filled table")
	stageForManualyEditedForm, _ = gongtable_fullstack.NewStackInstance(r, "manualy filled form")

	// to edit the data of the stack
	gongtable_data.Load(r, gongtable_go.GoModelsDir, "manualy filled table", stageForManualyEditedTable, backRepoForManualyEditedTable)
	gongtable_data.Load(r, gongtable_go.GoModelsDir, "manualy filled form", stageForManualyEditedForm, backRepoForManualyEditedForm)

	// generated stage is the stage generated by filling data with code
	// to test performances
	generatedStage, _ := gongtable_fullstack.NewStackInstance(r, "generated table")
	fillUpTableWithDummyStuff(generatedStage, "Table")
