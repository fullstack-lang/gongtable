...
func main() {
	...
	stageForManualyEditedTable = gongtable_fullstack.NewStackInstance(r, "manualy edited table")
	stageForManualyEditedForm = gongtable_fullstack.NewStackInstance(r, "manualy edited form")

	// to edit the data of the stack
	gongtable_data.Load(r, gongtable_go.GoModelsDir, "manualy edited table")
	gongtable_data.Load(r, gongtable_go.GoModelsDir, "manualy edited form")
