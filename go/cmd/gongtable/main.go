...
func main() {
	...
	nameOfManualyEditedTableStack := "manualy filled table"
	nameOfManualyEditedFormStack := "manualy filled form"
	nameOfAutomataclyFilledTableStack := "generated table"

	// persistence in a SQLite file on disk in memory
	stageForManualyEditedTable, backRepoForManualyEditedTable = gongtable_fullstack.NewStackInstance(r, nameOfManualyEditedTableStack)
	stageForManualyEditedForm, backRepoForManualyEditedForm = gongtable_fullstack.NewStackInstance(r, nameOfManualyEditedFormStack)

	// generated stage is the stage generated by filling data with code
	// to test performances
	generatedStage, _ := gongtable_fullstack.NewStackInstance(r, nameOfAutomataclyFilledTableStack)
	fillUpTableWithDummyStuff(generatedStage, gongtable_models.TableDefaultName.ToString())
	...
	// gongtable_data.Load(r, gongtable_go.GoModelsDir, nameOfManualyEditedFormStack, stageForManualyEditedForm, backRepoForManualyEditedForm)
...
func fillUpTableWithDummyStuff(stage *gongtable_models.StageStruct, tableName string) {
	nbRows := 200
	nbColumns := 10
	table := new(gongtable_models.Table).Stage(stage)
	table.Name = tableName
