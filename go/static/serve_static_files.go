...
import (
	...
	"github.com/fullstack-lang/gongtable"
...
func ServeStaticFiles(logGINFlag bool) (r *gin.Engine) {
	...
	r.Use(static.Serve("/", EmbedFolder(gongtable.NgDistNg, "ng-github.com-fullstack-lang-gongtable/dist/ng-github.com-fullstack-lang-gongtable/browser")))
