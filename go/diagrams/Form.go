...
var map_DocLink_Identifier_Form map[string]any = map[string]any{
	...
	"ref_models.FormField.BespokeHeightPx": (ref_models.FormField{}).BespokeHeightPx,
	...
	"ref_models.FormField.HasBespokeHeight": (ref_models.FormField{}).HasBespokeHeight,
	...
	"ref_models.FormGroup.HasSuppressButton": (ref_models.FormGroup{}).HasSuppressButton,

	"ref_models.FormGroup.HasSuppressButtonBeenPressed": (ref_models.FormGroup{}).HasSuppressButtonBeenPressed,
	...
	"ref_models.NoteOnFormFieldDateTime": ref_models.NoteOnFormFieldDateTime,
