...
func registerControllers(r *gin.Engine) {
	...
	{ // insertion point for registrations
		...
		v1.GET("/v1/formcells", GetController().GetFormCells)
		v1.GET("/v1/formcells/:id", GetController().GetFormCell)
		v1.POST("/v1/formcells", GetController().PostFormCell)
		v1.PATCH("/v1/formcells/:id", GetController().UpdateFormCell)
		v1.PUT("/v1/formcells/:id", GetController().UpdateFormCell)
		v1.DELETE("/v1/formcells/:id", GetController().DeleteFormCell)

		v1.GET("/v1/formcellbooleans", GetController().GetFormCellBooleans)
		v1.GET("/v1/formcellbooleans/:id", GetController().GetFormCellBoolean)
		v1.POST("/v1/formcellbooleans", GetController().PostFormCellBoolean)
		v1.PATCH("/v1/formcellbooleans/:id", GetController().UpdateFormCellBoolean)
		v1.PUT("/v1/formcellbooleans/:id", GetController().UpdateFormCellBoolean)
		v1.DELETE("/v1/formcellbooleans/:id", GetController().DeleteFormCellBoolean)

		v1.GET("/v1/formcellfloat64s", GetController().GetFormCellFloat64s)
		v1.GET("/v1/formcellfloat64s/:id", GetController().GetFormCellFloat64)
		v1.POST("/v1/formcellfloat64s", GetController().PostFormCellFloat64)
		v1.PATCH("/v1/formcellfloat64s/:id", GetController().UpdateFormCellFloat64)
		v1.PUT("/v1/formcellfloat64s/:id", GetController().UpdateFormCellFloat64)
		v1.DELETE("/v1/formcellfloat64s/:id", GetController().DeleteFormCellFloat64)

		v1.GET("/v1/formcellints", GetController().GetFormCellInts)
		v1.GET("/v1/formcellints/:id", GetController().GetFormCellInt)
		v1.POST("/v1/formcellints", GetController().PostFormCellInt)
		v1.PATCH("/v1/formcellints/:id", GetController().UpdateFormCellInt)
		v1.PUT("/v1/formcellints/:id", GetController().UpdateFormCellInt)
		v1.DELETE("/v1/formcellints/:id", GetController().DeleteFormCellInt)

		v1.GET("/v1/formcellstrings", GetController().GetFormCellStrings)
		v1.GET("/v1/formcellstrings/:id", GetController().GetFormCellString)
		v1.POST("/v1/formcellstrings", GetController().PostFormCellString)
		v1.PATCH("/v1/formcellstrings/:id", GetController().UpdateFormCellString)
		v1.PUT("/v1/formcellstrings/:id", GetController().UpdateFormCellString)
		v1.DELETE("/v1/formcellstrings/:id", GetController().DeleteFormCellString)
