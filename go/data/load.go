...
func Load(
	...
	tableRouter.Name = "github_com_fullstack_lang_gongtable_go" + "_table" + "_" + stackPath

	editorRouter := new(gongrouter_models.Outlet).Stage(gongrouterStage)
	editorRouter.Name = "github_com_fullstack_lang_gongtable_go" + "_editor" + "_" + stackPath
