...
export class FormFieldService {
  ...
  postFormField(formfielddb: FormFieldDB, GONG__StackPath: string): Observable<FormFieldDB> {
    ...
    let _Form_FormCells_reverse = formfielddb.Form_FormCells_reverse
    formfielddb.Form_FormCells_reverse = new FormDB
    ...
    return this.http.post<FormFieldDB>(this.formfieldsUrl, formfielddb, httpOptions).pipe(
      tap(_ => {
        ...
        formfielddb.Form_FormCells_reverse = _Form_FormCells_reverse
